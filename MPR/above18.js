...
const add_businessnews = (data) => {
    ...
    // Array of specific placeholder images for each article
    const placeholderImages = [
        '/images/b1.avif',  // For 1st article
        '/images/b2.avif',  // For 2nd article
        '/images/b3.avif',  // For 3rd article
        '/images/b4.avif'   // For 4th article
    ];
    ...
    data.forEach((element, index) => {
        ...
        // Use the specific placeholder for this article's index
        const specificPlaceholder = placeholderImages[index] || '/images/b2.avif';  // Fallback to default if there are more articles than placeholders
        const imageUrl = element.urlToImage || specificPlaceholder; // Fallback to specific placeholder image
...
const add_currentaffairsnews = (data) => {
    let html = '';
    let title = '';

    // Array of specific placeholder images for each article
    const placeholderImages = [
        '/images/p5.webp',  // For 1st article
        '/images/p6.webp',  // For 2nd article
        '/images/p2.webp',  // For 3rd article
        '/images/p3.webp',  // For 4th article
        '/images/p1.webp',  // For 5th article
        '/images/p4.webp'   // Additional placeholders if needed
    ];
    ...
    data.forEach((element, index) => {
        ...
        // Use a specific placeholder based on the article index
        const specificPlaceholder = placeholderImages[index] || '/images/default-placeholder.webp';  // Fallback to default if there are more articles than placeholders
        const imageUrl = element.urlToImage || specificPlaceholder; // Fallback to specific placeholder image
    ...
    currentaffairsnews.innerHTML = html;
}
fetchData('politics', 5).then(add_currentaffairsnews);
  // ANIMATION
